...
const translations = {
  en: {
    ...
    noFundersYet: 'No funders yet',
    addFundersToExpenses: 'Add funders to assign them to expenses',
    enterFunderName: 'Enter funder name',
    ...
    expensesByFunder: 'Expenses by Funder',
    noExpenseData: 'No expense data',
    noFunderData: 'No funder data',
    ...
    pleaseEnterExpenseTitle: 'Please enter an expense title',
    pleaseEnterValidAmount: 'Please enter a valid amount',
    pleaseSelectCategory: 'Please select a category',
    pleaseSelectEvent: 'Please select an event',
    expenseAddedSuccessfully: 'Expense added successfully',
    couldNotAddExpense: 'Could not add expense. Please try again.',
  ...
  si: {
    ...
    addNewExpense: 'වියදමක් එකතු කරන්න',
    viewAllCategories: 'සියලු ප්‍රවර්ග බලන්න',
    ...
    noEventsYet: 'තවම අවස්ථා නැත',
    untitledEvent: 'නමක් නැති අවස්ථාව',
    noDate: 'දිනයක් නැත',
    ...
    noFundersYet: 'තවම අරමුදල් සපයන්නන් නැත',
    addFundersToExpenses: 'වියදම් වලට පවරන්නට අරමුදල් සපයන්නන් එකතු කරන්න',
    enterFunderName: 'අරමුදල් සපයන්නාගේ නම ඇතුලත් කරන්න',
    phoneOptional: 'දුරකථනය (විකල්ප)',
    enterPhoneNumber: 'දුරකථන අංකය ඇතුලත් කරන්න',
    emailOptional: 'විද්‍යුත් තැපෑල (විකල්ප)',
    enterEmailAddress: 'විද්‍යුත් තැපෑල ඇතුලත් කරන්න',
    ...
    expensesByFunder: 'අරමුදල් සපයන්නන් අනුව වියදම්',
    noExpenseData: 'වියදම් දත්ත නැත',
    noFunderData: 'අරමුදල් සපයන්නන් දත්ත නැත',
    noDescription: 'විස්තර නැත',
    ...
    // New Expense Form
    title: 'ශීර්ෂය',
    enterExpenseTitle: 'වියදම් ශීර්ෂය ඇතුලත් කරන්න',
    enterAmount: 'ප්‍රමාණය ඇතුලත් කරන්න',
    enterExpenseDescription: 'වියදම් විස්තර ඇතුලත් කරන්න',
    selectEvent: 'අවස්ථාව තෝරන්න',
    selectCategory: 'ප්‍රවර්ගය තෝරන්න',
    selectFunder: 'අරමුදල් සපයන්නා තෝරන්න',
    assignedTo: 'පවරන ලද',
    saveExpense: 'වියදම සුරකින්න',
    pleaseEnterExpenseTitle: 'කරුණාකර වියදම් ශීර්ෂයක් ඇතුලත් කරන්න',
    pleaseEnterValidAmount: 'කරුණාකර වලංගු ප්‍රමාණයක් ඇතුලත් කරන්න',
    pleaseSelectCategory: 'කරුණාකර ප්‍රවර්ගයක් තෝරන්න',
    pleaseSelectEvent: 'කරුණාකර අවස්ථාවක් තෝරන්න',
    expenseAddedSuccessfully: 'වියදම සාර්ථකව එකතු කරන ලදී',
    couldNotAddExpense: 'වියදම එකතු කරන්න බෑ. කරුණාකර නැවත උත්සාහ කරන්න.',
    couldNotLoadData: 'දත්ත පූරණය කරන්න බෑ. කරුණාකර නැවත උත්සාහ කරන්න.',
  },
  ...
  ta: {
    ...
    addNewExpense: 'செலவைச் சேர்',
    viewAllCategories: 'அனைத்து வகைகளையும் பார்',
    viewAllExpenses: 'அனைத்து செலவுகளையும் பார்',
    ...
    untitledEvent: 'தலைப்பு இல்லாத நிகழ்வு',
    noDate: 'தேதி இல்லை',
    ...
    noFundersYet: 'இன்னும் நிதியளிப்பவர்கள் இல்லை',
    addFundersToExpenses: 'செலவுகளுக்கு ஒதுக்க நிதியளிப்பவர்களைச் சேர்க்கவும்',
    enterFunderName: 'நிதியளிப்பவரின் பெயரை உள்ளிடவும்',
    phoneOptional: 'தொலைபேசி (விருப்பமானது)',
    ...
    expensesByFunder: 'நிதியளிப்பவர் வாரியாக செலவுகள்',
    noExpenseData: 'செலவு தரவு இல்லை',
    noFunderData: 'நிதியளிப்பவர் தரவு இல்லை',
    ...
    // New Expense Form
    title: 'தலைப்பு',
    enterExpenseTitle: 'செலவு தலைப்பை உள்ளிடவும்',
    ...
    selectFunder: 'நிதியளிப்பவரைத் தேர்ந்தெடுக்கவும்',
    assignedTo: 'ஒதுக்கப்பட்டது',
    saveExpense: 'செலவைச் சேமி',
    pleaseEnterExpenseTitle: 'தயவுசெய்து செலவு தலைப்பை உள்ளிடவும்',
    pleaseEnterValidAmount: 'தயவுசெய்து சரியான தொகையை உள்ளிடவும்',
    pleaseSelectCategory: 'தயவுசெய்து வகையைத் தேர்ந்தெடுக்கவும்',
    pleaseSelectEvent: 'தயவுசெய்து நிகழ்வைத் தேர்ந்தெடுக்கவும்',
    expenseAddedSuccessfully: 'செலவு வெற்றிகரமாக சேர்க்கப்பட்டது',
    couldNotAddExpense: 'செலவைச் சேர்க்க முடியவில்லை. தயவுசெய்து மீண்டும் முயற்சிக்கவும்.',
    couldNotLoadData: 'தரவை ஏற்ற முடியவில்லை. தயவுசெய்து மீண்டும் முயற்சிக்கவும்.',
  }
};
